...
def build_record(
    ...
    *,
    ...
    return Record(
        ...
        uei=normalize_identifier(fields.get("uei")),
        duns=normalize_identifier(fields.get("duns")),
        ...
        topic_code=clean_text(fields.get("topic_code")),
        research_keywords=clean_text(fields.get("research_keywords")),
        raw=raw,
    )
